...
<a href="https://repairos.chanmeng.org/">
  <img src="docs/showcase/hero.webp" alt="RepairOS landing page hero — 'Run your repair shop with confidence' headline with orange CTA button and gear logo on a dark navy background" width="100%">
</a>

![Demo: scrolling through the RepairOS landing page, revealing work order tracking, customer management, billing and invoicing, parts and inventory, analytics, and multi-location support feature cards](docs/showcase/demo.gif)

<details>
<summary>📱 More screenshots</summary>

| Features Overview | Login & Sign Up | Mobile View |
|---|---|---|
| <img src="docs/showcase/features.webp" width="520"> | <img src="docs/showcase/login.webp" width="520"> | <img src="docs/showcase/mobile-hero.webp" width="260"> |
